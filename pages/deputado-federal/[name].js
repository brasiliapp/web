        ...
        <div className="flex w-full flex-col p-0 sm:p-6">
          ...
          >
            ...
            <Tab key="videos" title="Videos">
              <Card>
                <CardBody>
                  <tabs.Videos speechesData={data?.speechesData} federalDeputyName={data?.federalDeputyBaseInfo?.ultimoStatus?.nome}/>
                </CardBody>
              </Card>
            </Tab>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                            {data?.federalDeputyBaseInfo?.nomeCivil}
                          </p>
                        </div>
                      </div>
                    </li>
                    <li className="py-3 sm:pb-4">
                      <div className="flex items-center space-x-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                            {formatCPFCNPJ(data?.federalDeputyBaseInfo?.cpf)}
                          </p>
                        </div>
                      </div>
                    </li>
                    ...
                    <li className="py-3 sm:pb-4">
                      <div className="flex items-center space-x-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                            {data?.federalDeputyBaseInfo?.escolaridade}
                          </p>
                        </div>
                      </div>
                    </li>
                    <li className="py-3 sm:pb-4">
                      <div className="flex items-center space-x-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                            {formatDate(
                              data?.federalDeputyBaseInfo?.dataNascimento,
                            )}
                          </p>
                        </div>
                      </div>
