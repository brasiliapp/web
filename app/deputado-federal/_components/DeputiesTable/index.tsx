...
export function DeputiesTable({
  ...
  deputies: FederalDeputyPoliticalInfo[];
}) {
  const [state, setState] = useState<Selection>("all");
  const [party, setParty] = useState<Selection>("all");
  const [search, setSearch] = useState<string>("");

  const filteredDeputies: FederalDeputyPoliticalInfo[] = useMemo(() => {
    let result = deputies;
...
const renderRow = (deputy: FederalDeputyPoliticalInfo) => {
